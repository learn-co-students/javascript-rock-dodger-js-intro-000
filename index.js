...
function checkCollision(rock) {
  ...
  if (top > 360) {
    ...
    const dodgerRightEdge = dodgerLeftEdge + 40; // The DODGER is 40 pixels wide -- how do we get the right edge?
                                                        // We are given the left edge for the dodger and are told that the dodger is 40 pixels wide.
                                                        // In order to obtain the cordinate for the right edge, we simply add the 40 pixels from the left edge.
    const rockLeftEdge = positionToInteger(rock.style.left)
    const rockRightEdge = rockLeftEdge + 20; // The rock is 20 pixel's wide -- how do we get the right edge?
                                                        // We are given the left edge for the rock and are told that the rock is 20 pixels wide.
                                                        // In order to obtain the cordinate for the right edge, we simply add the 20 pixels from the left edge.

    /**
    * Think about it -- what's happening below?
