...
function checkCollision(rock) {
  ...
  if (top > 360) {
    ...
    if (/*(voy a borrar este false:)false/**
               ...
               *    and the rock's right edge is > the DODGER's right edge
               */
                (rockLeftEdge<dodgerLeftEdge && dodgerLeftEdge<=rockRightEdge)
...
function moveDodgerRight() {
   ...
   */
   window.requestAnimationFrame(function(){
     ...
     if(rightPos<GAME_WIDTH-40){
       DODGER.style.left=`${rightPos+4}px`
     }
   })
};
