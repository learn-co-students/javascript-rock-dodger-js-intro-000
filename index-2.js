...
console.log("error test ", dodgerRightEdge)
...
function createRock(x) {
  ...
  function moveRock() {
     ...
     */
     else if(rock.style.top < 380) { // AK: do we know what rock.style.bottom is? Is 0 the proper lower bound? {changed it, looking at top}
...
function moveDodgerRight() {
   ...
   * (mabye 4 pixels?). Use window.requestAnimationFrame()!
   */
   var right = DODGER.style.left

   function step() {
     if (DODGER.style.right < 400) {
       DODGER.style.left = `${positionToInteger(DODGER.style.left)+=1}px`
